...
static int is31fl3236a_reset(struct is31fl32xx_priv *priv);
static const struct is31fl32xx_chipdef is31fl3236a_cdef = {
	...
	.pwm_global_control_reg		= 0x4b,
	.pwm_registers_reversed			= true,
	.led_control_register_base		= 0x26,
	.enable_bits_per_led_control_register	= 1,
	.reset_func				= is31fl3236a_reset,
};
...
static int is31fl3236a_reset(struct is31fl32xx_priv *priv)
{
	printk("is31fl3236a reset\n");
	return is31fl32xx_write(priv, priv->cdef->pwm_global_control_reg, 1);
}
/*
