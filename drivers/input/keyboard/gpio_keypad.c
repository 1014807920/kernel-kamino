...
*/
	...
	input_dev->rep[REP_DELAY] = 500;    //500ms
	input_dev->rep[REP_PERIOD] = 500;   //500ms
...
//ROKID BEGIN
	input_enable_softrepeat(kp->input, kp->input->rep[REP_DELAY], kp->input->rep[REP_PERIOD]);
//ROKID END
/*set_pwr_key();*/
