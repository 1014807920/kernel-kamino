...
static const struct snd_kcontrol_new ad82584f_snd_controls[] = {
	...
	SOC_ENUM_EXT("SoftMute Control (on/off)", ad82584f_mute_sel,
		     ad82584f_mute_get, ad82584f_mute_put)
};
...
static int ad82584f_dai_digital_mute(struct snd_soc_dai *codec_dai, int mute)
{
...
static const struct snd_soc_codec_driver soc_codec_dev_ad82584f = {
	...
	.component_driver = {
			     ...
			     .num_dapm_widgets =
			     ARRAY_SIZE(ad82584f_dapm_widgets),
			     }
};
