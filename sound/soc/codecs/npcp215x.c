...
static unsigned char MaxxAudio_Cmd_FULL_Init[] = {
	...
	0x00, 0xA4, 0x11,  // Load Mixer Gains - Start
 	0x0F, 0xBF, 0x58,  // M1 - SDI0 to Processing path (-0.20dB)
 	...
 	0x16, 0xDD, 0xF6,  // M9 - SDO0 from Processed path (-14.96dB)
 	0x00, 0x00, 0x00,  // M10- SDO1 from Processed path (-inf)
 	0x5B, 0x09, 0x0A,  // M11- SDO3 from Processed path (DAC1/AMP) (-2.96dB)
	...
	0x01, 0xD0, 0x90,  // Set MaxxVolume Gain : 0.0 dB
 	...
 	0x00, 0x00, 0x05,  // Ch: 6
 	0x00, 0x00, 0x00,  // Type: Bell
 	0x00, 0x00, 0x4C,  // Freq: 1290 Hz
 	0x00, 0x00, 0x68,  // Q: 4.99
 	0x00, 0x00, 0x4A,  // Gain: +2.8
 	0x00, 0xD8, 0x00,  // Load PEQ End
 	0x00, 0xA1, 0x05,  // Load PEQ Start
 	0x00, 0x00, 0x06,  // Ch: 7
 	0x00, 0x00, 0x00,  // Type: Bell
 	0x00, 0x00, 0x55,  // Freq: 2170 Hz
 	0x00, 0x00, 0x68,  // Q: 4.99
 	0x00, 0x00, 0x4A,  // Gain: +2.8
 	0x00, 0xD8, 0x00,  // Load PEQ End
 	0x00, 0xA1, 0x05,  // Load PEQ Start
...
static unsigned char MaxxAudio_Cmd_Init_Alg[] = {
 	//#  Start Algorithm Configuration
	0x00, 0xF4, 0x00,  // Sub EQ - Bypass, No Reset
 	0x01, 0xF4, 0x01,  // Sub EQ - Active, Reset
 	0x00, 0xF4, 0x00,  // Sub EQ - Bypass, No Reset
