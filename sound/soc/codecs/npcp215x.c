...
static unsigned char MaxxAudio_Cmd_FULL_Init[] = {
	0x00, 0xA5, 0x00,  // Setup Start (start initialization state) 
 	...
 	0x16, 0xDD, 0xF6,  // M9 - SDO0 from Processed path (-14.96 dB)
 	0x00, 0x00, 0x00,  // M10- SDO1 from Processed path (-inf)
 	0x5D, 0x95, 0xF6,  // M11- SDO3 from Processed path (DAC1/AMP) (-2.72 dB)
 	...
 	0x00, 0xD5, 0x62,  // Set MaxxBass Cutoff Freq : 84.1 Hz
 	0x00, 0xCF, 0x2D,  // Set Bypass Algorithm. Bypass is enabled for : High Pass Filter, Maxx3D, MaxxDialog, MaxxTreble, 
 	...
 	0x00, 0xD1, 0x0B,  // Set MaxxBass Intensity : 14.5 %
 	0x00, 0xCF, 0x2D,  // Set Bypass Algorithm. Bypass is enabled for : High Pass Filter, Maxx3D, MaxxDialog, MaxxTreble, 
 	0x00, 0xCF, 0x2D,  // Set Bypass Algorithm. Bypass is enabled for : High Pass Filter, Maxx3D, MaxxDialog, MaxxTreble, 
 	0x00, 0xCF, 0x2D,  // Set Bypass Algorithm. Bypass is enabled for : High Pass Filter, Maxx3D, MaxxDialog, MaxxTreble, 
 	0x00, 0xCF, 0x2D,  // Set Bypass Algorithm. Bypass is enabled for : High Pass Filter, Maxx3D, MaxxDialog, MaxxTreble, 
