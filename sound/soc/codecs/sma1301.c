...
static unsigned int sma1301_reg_original_value[256] = {
	...
	0x17, 0x00, 0x30, 0x30, 0x58, 0x58, 0xff, 0x0f, 	/* 0x08 - 0x0f */
	0x04, 0xe0, 0x00, 0x23, 0x12, 0x01, 0x08, 0x08, 	/* 0x10 - 0x17 */
	...
	0x2c, 0x2c, 0x38, 0x00, 0x00, 0x59, 0x92, 0x3f, 	/* 0x30 - 0x37 */
	...
	0x00, 0x42, 0x80, 0x02, 0x37, 0x0f, 0x82, 0x6a, 	/* 0x90 - 0x97 */
	0xdf, 0xff, 0xff, 0xfd, 0xd7, 0xdb, 0xf9, 0x37, 	/* 0x98 - 0x9f */
	0xf3, 0xff, 0x68, 0x28, 0x40, 0xff, 0xf8, 0xea, 	/* 0xa0 - 0xa7 */
...
static int sma1301_init_codec_reg(struct snd_soc_codec *codec)
{
	...
	for (i = 0; i <= SMA1301_FF_DEVICE_INDEX; i ++) {
		...
		regmap_write(sma1301->regmap, be32_to_cpu(sma1301_reg_def[i].reg),
					be32_to_cpu(sma1301_reg_def[i].def));
	}
