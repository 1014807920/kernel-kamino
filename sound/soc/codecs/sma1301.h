 ...
 * r000, 2018.01.09
 *
 * Copyright 2017 Silicon Mitus Corporation / Iron Device Corporation
 *
...
/* 0x1C ~ 0x22 : Reserved */
#define  SMA1301_23_COMPLIM1		0x23
#define  SMA1301_24_COMPLIM2		0x24
#define  SMA1301_25_COMPLIM3		0x25
#define  SMA1301_26_COMPLIM4		0x26
/* 0x27 ~ 0x2A : Reserved */
...
/* FLLCTRL */
#define  SMA1301_33_FLL_CTRL		0x33
/* 0x34 ~ 0x35 : Reserved */
...
#define PCM_N_SLOT11 (0xA<<0)
#define PCM_N_SLOT12 (0xB<<0)
#define PCM_N_SLOT13 (0xC<<0)
#define PCM_N_SLOT10 (9<<0)
#define PCM_N_SLOT14 (0xD<<0)
#define PCM_N_SLOT15 (0xE<<0)
#define PCM_N_SLOT16 (0xF<<0)

/* INTPUT CTRL4 : 0x04 */
#define PCM1_SLOT_MASK (0xF<<4)
...
#define PCM1_SLOT11 (0xA<<4)
#define PCM1_SLOT12 (0xB<<4)
#define PCM1_SLOT13 (0xC<<4)
#define PCM1_SLOT14 (0xD<<4)
#define PCM1_SLOT15 (0xE<<4)
#define PCM1_SLOT16 (0xF<<4)

#define PCM2_SLOT_MASK (0xF<<0)
...
#define PCM2_SLOT11 (0xA<<0)
#define PCM2_SLOT12 (0xB<<0)
#define PCM2_SLOT13 (0xC<<0)
#define PCM2_SLOT14 (0xD<<0)
#define PCM2_SLOT15 (0xE<<0)
#define PCM2_SLOT16 (0xF<<0)
...
/* SYSTEM_CTRL1 :0x10 */
#define LRSWAP_MASK (1<<5)
#define LRSWAP (1<<5)
#define LR_NORMAL (0<<5)
...
/* Modulator : 0x14 : R002 */
#define SPK_HYSFB_MASK ()
#define HYSFB_625K (0<<6)
#define HYSFB_414K (1<<6)
#define HYSFB_297K (2<<6)
#define HYSFB_226K (3<<6)
#define SPK_BDELAY_MASK ()

/* EQ_MODE : 0x2B : R002 */
#define EQ_LEFT_MUX_MASK (3<<6)
#define EQ_RIGHT_MUX_MASK (3<<4)
#define EQ_ALL_NO_BYPASS (0<<4)
#define EQ1_R_BYPASS (1<<4)
#define EQ2_L_BYPASS (2<<4)
#define EQ_ALL_BYPASS (3<<4)

#define SEL_BANK_MASK (1<<3)
#define EQ1_BANK (0<<3)
#define EQ2_BANK (1<<3)

#define EQ_MODE_MASK (0x07<<0)
...
#define QUART_SEL_1_DIV_4 (0<<6)
#define QUART_SEL_1_DIV_8 (1<<6)

/* PROTECTION : 0x36 */
#define EGDE_DIS_MASK (1<<7)
#define EGDE_DIS_ENABLE (0<<7)
#define EGDE_DIS_DISABLE (1<<7)
...
/* CLASS G CONTROL 0x91 */
#define CLASS_G_ATTACK_LVL_MASK (0xF<<4)
#define CLASS_G_ATTACK_LVL_DIS_L (0<<4)
#define CLASS_G_ATTACK_LVL_0P0625FS (1<<4)
#define CLASS_G_ATTACK_LVL_0P125FS (2<<4)
#define CLASS_G_ATTACK_LVL_0P25FS (4<<4)
#define CLASS_G_ATTACK_LVL_0P5FS (8<<4)
#define CLASS_G_ATTACK_LVL_DIS_H (0xF<<4)

#define CLASS_G_RELEASE_TIME_MASK (0xF<<4)
#define CLASS_G_RELEASE_TIME_20MS (1<<4)
#define CLASS_G_RELEASE_TIME_40MS (2<<4)
#define CLASS_G_RELEASE_TIME_80MS (4<<4)
#define CLASS_G_RELEASE_TIME_160MS (8<<4)

/* FDPEC CONTROL : 0x92 */
#define FLT_VDD_GAIN_MASK (0x1F<<3)
...
#define EXTERNAL1_CLK (0<<4)
#define INTERNAL_OSC (1<<4)
...
#define DIS_AUTO_RC_MASK (1<<3)
#define ENABLE_AUTO_RC (0<<3)
#define DISABLE_AUTO_RC (1<<3)

#define I2C_OE1_MASK (1<<2)
#define DISABLE_CH1 (0<<2)
#define ENABLE_CH1 (1<<2)

#define I2C_OE2_MASK (1<<1)
#define DISABLE_CH2 (0<<1)
#define ENABLE_CH2 (1<<1)

#define I2C_CE_MASK (1<<1)
#define DISABLE_CE (0<<1)
