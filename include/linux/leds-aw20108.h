 ...
 *This driver will use load firmware if AW20108_BIN_CONFIG be defined
 *****************************************************/
//#define  AW20108_BIN_CONFIG
#define  AW20108_ARRAY_CONFIG
/******************************************************
 *
 * Register List
 *
...
#define AW20108_REG_MAX                 0x100

const unsigned char aw20108_reg_access[AW20108_REG_MAX] = {
...
#define BIT_GCR_CHIPEN_ENABLE           (1<<7)
#define BIT_GCR_CHIPEN_DISABLE          (0<<7)
...
#define BIT_IMAX_MASK                   (~(7<<4))
#define AW20108_DBGCTR_DIM 0x3F
#define AW20108_DBGCTR_FDAD 0xFF
/*********************************************************
 *
 * pag num
 *
...
#define AW20108_REG_NUM_PAG4       108
#define AW20108_REG_NUM_PAG5       108


#define AW20108_RGB_MAX     9
/*********************************************************
 *
 * chip info
 *
 ********************************************************/
#define AW20108_RSTR       0x01
#define AW20108_CHIPID      0x18

enum aw20108_flags {
    AW20108_FLAG_NONE = 0,
    AW20108_FLAG_SKIP_INTERRUPTS = 1,
};

enum aw20108_reg_page {
    AW20108_REG_PAGE0 = 0xC0,
    AW20108_REG_PAGE1 = 0xC1,
    AW20108_REG_PAGE2 = 0xC2,
    AW20108_REG_PAGE3 = 0xC3,
    AW20108_REG_PAGE4 = 0xC4,
    AW20108_REG_PAGE5 = 0xC5,
};

enum aw20108_dbgctr {
    AW20108_DBGCTR_NORMAL = 0,
    AW20108_DBGCTR_IRAM = 1,
    AW20108_DBGCTR_SFR = 2,
    AW20108_DBGCTR_FLASH = 3,
    AW20108_DBGCTR_MAX = 4,
};

enum aw20108_imax {
    AW20108_IMAX_3P3mA = 0x08,
    AW20108_IMAX_6P7mA = 0x09,
    AW20108_IMAX_10mA = 0x00,
    AW20108_IMAX_13P3mA = 0x0B,
    AW20108_IMAX_20mA = 0X01,
    AW20108_IMAX_26P7mA = 0x0D,
    AW20108_IMAX_30mA = 0x02,
    AW20108_IMAX_40mA = 0x06,
    AW20108_IMAX_53P6mA = 0x0F,
    AW20108_IMAX_60mA = 0x04,
    AW20108_IMAX_80mA = 0x05,
    AW20108_IMAX_120mA = 0x06,
    AW20108_IMAX_160mA = 0x07,
};
 ...
 *
 ********************************************************/
#define AW20108_AUDIO_INITGAIN      0x1F
...
struct aw20108 {
    ...
    unsigned int rgb[AW20108_RGB_MAX];
    unsigned int rgbcolor;
    unsigned int rgbbrightness;
};

typedef struct aw20108_cfg {
	unsigned char  *p;
	unsigned int count;
} AW20108_CFG;
